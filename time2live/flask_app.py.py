    ...
    if request.method == 'POST':
        ...
        if (healthy_years_left > 0):
            for y in range(healthy_years_left):
                if image_switch == 0:
                    healthy_image_list.append('static/images/running.png')
                elif image_switch == 1:
                    healthy_image_list.append('static/images/jumping.png')
                elif image_switch == 2:
                    healthy_image_list.append('static/images/streching.png')
                elif image_switch == 3:
                    healthy_image_list.append('static/images/weight-lifting.png')
                # elif image_switch == 4:
                #     healthy_image_list.append('static/images/.png')
                else:
